...
export default function CardRendezVous () {
    return(
        <div className="flex border-2 border-black/15 h-[120px] shadow px-4 py-2 m-2">
            <div className="flex justify-between items-center w-full">
                <div id="card-infos">
                    <h3 id="card-infos__date" className="text-2xl italic">Lundi 14 Mai 2024</h3>
                    <div id="card-infos__client" className="ml-3 text-xl mt-2">
                        ...
                        <div id="card-infos__client-name" className="flex gap-3">
                            ...
                            <p>22 rue des tisserands, 56190 Noyal-Muzillac</p>
                        </div >
                    </div>
                </div>
