...
export default function SignupForm() {
  ...
  return (
      <div className="w-full max-w-[500px] px-3 md:w-1/2">
          <h1 className={`${lusitana.className} text-4xl font-bold mb-6 flex justify-center`}>{`S'enregistrer`}</h1>

          <form ref={formRef} action={loginUser} className="flex flex-col justify-center bg-white p-6 rounded-xl shadow-xl">
            <div className="flex gap-2">
              <div className="mb-4">
                  <label htmlFor="lastname" className={`${lusitana.className} block font-bold text-xl`}>Nom</label>
                  <input
                      type="text"
                      id="lastname"
                      name="lastname"
              ...
              <div className="mb-4">
                  <label htmlFor="firstname" className={`${lusitana.className} block font-bold text-xl`}>Prénom</label>
                  <input
                      type="text"
                      id="firstname"
                      name="firstname"
            ...
            <div className="mb-4">
                  <label htmlFor="phone" className={`${lusitana.className} block font-bold text-xl`}>Téléphone</label>
                  <input
                      type="tel"
                      id="phone"
                      name="phone"
