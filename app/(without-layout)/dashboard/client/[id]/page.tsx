...
export default function SingleClientPage({
    ...
    return (
        <>
            ...
            <div id="single-client-container" className="border border-black/10 shadow-lg bg-white h-full max-w-4xl mt-2 w-full mx-auto">
                <div id="user-grid-container" className="flex h-full w-full justify-center items-center">
                    <div id="img-container" className="flex justify-center w-1/2">
                    <div>
                            {image ? ( 
                                <Image className="rounded-full" src={image} width={250} height={250} alt='Avatar client' />
                            ) : (
                                <Image className="rounded-full" src={NoAvatar} width={250} height={250} alt='Avatar absent' />
                            )}
                        </div>
                    </div>
                    <div id="client-infos-container" className="flex flex-col gap-4 items-center w-1/2">
                        ...
                        <div>
                            <h3 className={`${lusitana.className} font-bold text-center text-xl text-greena-500`}>Dossier</h3>
                            <button 
                                type="button" 
