export function EditInactiveIcon(props : {className: string}) {
    return (
      <svg
        {...props}
        viewBox="0 0 20 20"
...
export function EditActiveIcon(props : {className: string}) {
    return (
      <svg
        {...props}
        viewBox="0 0 20 20"
  ...
  export function SofaIcon(props: { className: string }) {
    return (
      <svg 
        {...props}
        viewBox="0 0 24 24" 
        ...
        <path 
        d="M20 10C20 9.07069 20 8.60603 19.9231 8.21964C19.6075 6.63288 18.3671 5.39249 16.7804 5.07686C16.394 5 15.9293 5 15 5H9C8.07069 5 7.60603 5 7.21964 5.07686C5.63288 5.39249 4.39249 6.63288 4.07686 8.21964C4 8.60603 4 9.07069 4 10" stroke="#FFFFFF" strokeWidth="1.5"></path> <path d="M20 19V18M4 19V18" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round"></path> </g>
        </svg>

    );
  }

  export function TalkIcon(props: { className: string}) {
    return (
      <svg 
      {...props}
      viewBox="0 0 16 16" 
