...
export default function CgvPage() {
  return (
    <div
      id="cgv-container"
      className="flex flex-col grow justify-center p-6 gap-6 w-full md:max-w-4xl mx-auto"
    >
      <div id="cgv-intro" className="flex flex-col gap-6">
        <h1 className={`${lusitana.className} text-4xl text-center text-greena-400 md:text-5xl font-bold`}>
      ...
      <section>
        <h2
          className={`${lusitana.className} text-2xl text-start mb-2 text-greena-400 md:text-3xl font-bold`}
        >
          Clause Générale
        </h2>
        <p className="text-justify">
      ...
      <section>
        ...
        <ul className="list-disc pl-6 mt-2">
          ...
          <li>
            Ateliers de sophrologie sur différents thèmes auprès des entreprises, collectivités,
            établissements scolaires publics ou privés sans que cela soit limitatif.
          </li>
        </ul>
      </section>
      <section>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 my-2">
          ...
          <li>
            {`De son droit au délai de rétractation de 14 jours en cas de visite à domicile 
